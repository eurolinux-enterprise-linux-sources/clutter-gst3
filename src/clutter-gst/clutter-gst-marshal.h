...
extern void _clutter_gst_marshal_VOID__DOUBLE_DOUBLE (GClosure     *closure,
                                                      GValue       *return_value,
...
extern void _clutter_gst_marshal_VOID__INT_INT (GClosure     *closure,
                                                GValue       *return_value,
                                                guint         n_param_values,
                                                const GValue *param_values,
                                                gpointer      invocation_hint,
...
extern void _clutter_gst_marshal_BOOLEAN__OBJECT (GClosure     *closure,
                                                  GValue       *return_value,
                                                  guint         n_param_values,
                                                  const GValue *param_values,
                                                  gpointer      invocation_hint,
